...
Obsidian 재구축 작업을 진행하면서 또 다른 심각한 문제를 발견했어요. **Notion에도 똑같은 정보들이 중복으로 저장**되어 있더라고요!
...
<div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem; margin: 2rem 0;">
  ...
  <img src="/images/stories/a-03/notion_before02.webp" alt="중복되는 데이터뷰" style="width: 100%; border-radius: 8px;" />
...
📋 오늘 할 일 뷰 (극도의 단순함)
<div style="margin: 2rem 0;">
  <img src="/images/stories/a-03/notion_api.webp" alt="기한 경과 태스크 처리 시스템" style="width: 100%; border-radius: 8px;" />
</div>
